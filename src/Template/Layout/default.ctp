...
<script>
    var trans = {
        ...
        accent_headline_warning: '<?= htmlspecialchars(__('Two magenta headlines are only allowed, if the message requires it and would make less sense otherwise. Is this the case?'), ENT_QUOTES) ?>',
